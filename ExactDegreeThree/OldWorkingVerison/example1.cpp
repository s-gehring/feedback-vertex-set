...
int main(int argc, char** argv)
  ...
  //mat A;  // directly specify the matrix size (elements are uninitialised)
  ...
  //matrixToStadardForm(A).print("Result");
